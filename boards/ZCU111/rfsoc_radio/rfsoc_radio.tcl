...
\
  ...
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins DataInspectorRx/aresetn] [get_bd_pins receiver/receiver_aresetn] [get_bd_pins axi_dma_rx/axi_resetn] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins ps8_axi_periph/M04_ARESETN] [get_bd_pins ps8_axi_periph/M05_ARESETN] [get_bd_pins ps8_axi_periph/M06_ARESETN] [get_bd_pins usp_rf_data_converter/m0_axis_aresetn]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -with_name SEG_axi_dma_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspectorTx/axi_dma/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -with_name SEG_data_inspector_module_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspectorTx/data_inspector_module/inspector_s_axi/reg0] -force
