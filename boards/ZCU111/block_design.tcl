...
set design_name rfsoc_radio_bpsk
...
proc create_root_design { parentCell } {
  ...
  set usp_rf_data_converter [ create_bd_cell -type ip -vlnv xilinx.com:ip:usp_rf_data_converter:2.1 usp_rf_data_converter ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins DataInspector/S_AXIS] [get_bd_intf_pins bpsk_receiver/m_axis_op]
  ...
  connect_bd_intf_net -intf_net bpsk_receiver_m_axis [get_bd_intf_pins axi_dma_rx/S_AXIS_S2MM] [get_bd_intf_pins bpsk_receiver/m_axis]
  connect_bd_intf_net -intf_net bpsk_transmitter_m_axis [get_bd_intf_pins bpsk_transmitter/m_axis] [get_bd_intf_pins usp_rf_data_converter/s12_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_m00_axis [get_bd_intf_pins bpsk_receiver/s_axis_re] [get_bd_intf_pins usp_rf_data_converter/m00_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_m01_axis [get_bd_intf_pins bpsk_receiver/s_axis_im] [get_bd_intf_pins usp_rf_data_converter/m01_axis]
  ...
  connect_bd_net -net bpsk_receiver_irq [get_bd_pins bpsk_receiver/irq] [get_bd_pins xlconcat/In1]
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins DataInspector/aresetn] [get_bd_pins axi_dma_rx/axi_resetn] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins bpsk_receiver/bpsk_receiver_aresetn] [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M04_ARESETN] [get_bd_pins ps8_axi_periph/M05_ARESETN] [get_bd_pins ps8_axi_periph/M06_ARESETN] [get_bd_pins usp_rf_data_converter/m0_axis_aresetn]
  connect_bd_net -net proc_sys_reset_dac1_peripheral_aresetn [get_bd_pins axi_dma_tx/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins bpsk_transmitter/bpsk_transmitter_aresetn] [get_bd_pins proc_sys_reset_dac1/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M01_ARESETN] [get_bd_pins ps8_axi_periph/M02_ARESETN] [get_bd_pins usp_rf_data_converter/s1_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_clk_dac1 [get_bd_pins axi_dma_tx/m_axi_mm2s_aclk] [get_bd_pins axi_dma_tx/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins bpsk_transmitter/clk] [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M02_ACLK] [get_bd_pins usp_rf_data_converter/clk_dac1] [get_bd_pins usp_rf_data_converter/s1_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_dma_rx/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH] SEG_zynq_ultra_ps_e_HP2_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_rx/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] SEG_zynq_ultra_ps_e_HP2_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_rx/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM] SEG_zynq_ultra_ps_e_HP2_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_rx/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_QSPI] SEG_zynq_ultra_ps_e_HP2_QSPI
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_dma_tx/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_tx/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_tx/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_HP0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_tx/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_HP0_QSPI
  create_bd_addr_seg -range 0x00001000 -offset 0xA0045000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspector/axi_dma/S_AXI_LITE/Reg] SEG_axi_dma_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0044000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_dma_rx/S_AXI_LITE/Reg] SEG_axi_dma_rx_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0041000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_dma_tx/S_AXI_LITE/Reg] SEG_axi_dma_tx_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0042000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] SEG_axi_intc_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0043000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs bpsk_receiver/bpsk_receiver_s_axi/reg0] SEG_bpsk_receiver_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0040000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs bpsk_transmitter/bpsk_transmitter_s_axi/reg0] SEG_bpsk_transmitter_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0046000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspector/data_inspector_module/data_inspector_module_s_axi/reg0] SEG_data_inspector_module_reg0
  create_bd_addr_seg -range 0x00040000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs usp_rf_data_converter/s_axi/Reg] SEG_usp_rf_data_converter_Reg
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH] SEG_zynq_ultra_ps_e_HP2_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] SEG_zynq_ultra_ps_e_HP2_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM] SEG_zynq_ultra_ps_e_HP2_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces DataInspector/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_QSPI] SEG_zynq_ultra_ps_e_HP2_QSPI
