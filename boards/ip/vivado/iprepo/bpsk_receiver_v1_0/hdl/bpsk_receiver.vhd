...
architecture structural of bpsk_receiver_cic_decimator is 
  ...
  signal shift2_op_net : std_logic_vector( 26-1 downto 0 );
begin
  ...
  shift1 : entity xil_defaultlib.sysgen_shift_3b3ba45932 
  port map (
    clr => '0',
  ...
  shift2 : entity xil_defaultlib.sysgen_shift_3b3ba45932 
  port map (
    clr => '0',
...
architecture structural of bpsk_receiver_observation_point is 
  ...
  signal mux_im1_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
  signal clk_5_net : std_logic;
  signal ce_5_net : std_logic;
...
begin
  ...
  fir_compiler_7_2_m_axis_data_tvalid_net_x0 <= valid_e;
  cic_decimator_real_m_axis_data_tvalid_net <= valid_d;
  fir_compiler_7_2_m_axis_data_tvalid_net <= valid_c;
  delay1_q_net <= real_b;
  convert_dout_net_x1 <= real_e;
  cmult2_p_net <= real_d;
  convert_dout_net_x0 <= real_c;
  register4_q_net <= valid_a;
  delay2_q_net <= imag_b;
  convert1_dout_net_x1 <= imag_e;
  cmult1_p_net <= imag_d;
  ...
  m_axis_op_tvalid <= mux_im1_y_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  clk_5_net <= clk_5;
  ce_5_net <= ce_5;
  ...
  mux_im1 : entity xil_defaultlib.sysgen_mux_9acf3e3f4e 
  port map (
    clr => '0',
    sel => slice_y_net,
    d0 => up_sample9_q_net,
    ...
    d4(0) => fir_compiler_7_2_m_axis_data_tvalid_net_x0,
    clk => clk_net,
    ce => ce_net,
    y => mux_im1_y_net
  );
...
begin
  ...
  port map (
    s_axis_data_tdata_path1 => cmult2_p_net,
    s_axis_data_tdata_path0 => cmult1_p_net,
    src_clk => clk_5_net,
    src_ce => ce_5_net,
    clk => clk_net,
    ce => ce_net,
...
begin
  ...
  port map (
    ...
    valid_e => fir_compiler_7_2_m_axis_data_tvalid_net,
    valid_d => cic_decimator_real_m_axis_data_tvalid_net,
    valid_c => fir_compiler_7_2_m_axis_data_tvalid_net_x0,
    real_b => delay1_q_net,
    real_e => convert_dout_net,
    real_d => cmult2_p_net,
    real_c => convert_dout_net_x0,
    valid_a => register4_q_net,
    imag_b => delay2_q_net,
    imag_e => convert1_dout_net,
    imag_d => cmult1_p_net,
