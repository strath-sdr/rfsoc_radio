...
begin
  ...
  relational2 : entity xil_defaultlib.sysgen_relational_fd5ba174e9 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_0d4132aa90 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant4 : entity xil_defaultlib.sysgen_constant_fa24cb9652 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_0d4132aa90 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant6 : entity xil_defaultlib.sysgen_constant_f392e17b46 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  counter1 : entity xil_defaultlib.bpsk_receiver_xlcounter_limit 
  generic map (
    cnt_15_0 => 1023,
    cnt_31_16 => 0,
    cnt_47_32 => 0,
  ...
  counter2 : entity xil_defaultlib.bpsk_receiver_xlcounter_limit 
  generic map (
    cnt_15_0 => 1023,
    cnt_31_16 => 0,
    cnt_47_32 => 0,
  ...
  fast_fourier_transform_9_1 : entity xil_defaultlib.xlfast_fourier_transform_b390f978b4c74774f03f6ff2c16022ef 
  port map (
    ...
    m_axis_data_tready => constant2_op_net,
    clk => clk_5_net,
    ce => ce_5_net,
  ...
  mux : entity xil_defaultlib.sysgen_mux_88e7543246 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_b7f2358c2c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_68b1d293da 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  product2 : entity xil_defaultlib.xlbpsk_receiver_cmpy_v6_0_i0_b12635ef7921d62dc55bb019f70b2741 
  port map (
    a_re => cmult2_p_net,
    a_im => cmult1_p_net,
    b_re => cmult2_p_net,
...
begin
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_dc674f85ab 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_f27017238e 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux : entity xil_defaultlib.sysgen_mux_ca444b551c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational : entity xil_defaultlib.sysgen_relational_456af8de30 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_93b79cb2ae 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  generic map (
    ...
    c_output_width => 32,
    c_type => 0,
    core_name0 => "bpsk_receiver_mult_gen_v12_0_i9",
    extra_registers => 0,
    multsign => 2,
    overflow => 2,
    p_arith => xlUnsigned,
  ...
  reinterpret : entity xil_defaultlib.sysgen_reinterpret_018687879c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_018687879c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
