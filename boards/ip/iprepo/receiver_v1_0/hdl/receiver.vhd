...
begin
  ...
  product : entity xil_defaultlib.xlreceiver_cmpy_v6_0_i0_6698440769124c32b51756696dc27536 
  port map (
...
begin
  ...
  src_clk_net <= clk_20;
  src_ce_net <= ce_20;
  addsub1 : entity xil_defaultlib.sysgen_addsub_7ad2ec4b04 
  port map (
    clr => '0',
    a => constant_op_net,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_59eebd8457 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  src_clk_net <= clk_20;
  src_ce_net <= ce_20;
  addsub1 : entity xil_defaultlib.sysgen_addsub_2649b575e2 
  port map (
    clr => '0',
    a => delay2_q_net,
    b => constant_op_net,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_8f5bce2a0a 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_16733fff5a 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_6e01a89e19 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_fc94b08278 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_1aec2b31c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_7e0b42dbd5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_fef3ac9c67 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
architecture structural of receiver_generate_angle_error is 
  ...
  signal register4_q_net_x0 : std_logic_vector( 20-1 downto 0 );
  signal delay_q_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  mux : entity xil_defaultlib.sysgen_mux_e609618d3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  product : entity xil_defaultlib.xlreceiver_cmpy_v6_0_i0_801a5b921ed938410f2c21f8acc38ddd 
  port map (
    a_re => cmult2_p_net,
    a_im => cmult1_p_net,
...
begin
  ...
  product1 : entity xil_defaultlib.xlreceiver_cmpy_v6_0_i1_2d43eaaac9708cbda8db82edf18b2aca 
  port map (
  ...
  product2 : entity xil_defaultlib.xlreceiver_cmpy_v6_0_i0_801a5b921ed938410f2c21f8acc38ddd 
  port map (
    a_re => cmult2_p_net,
    a_im => cmult1_p_net,
    b_re => cmult2_p_net,
...
-- Generated from Simulink block receiver/Frame Synchronisation/QPSK Frame Sync/DQPSK Imag Convert
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receiver_dqpsk_imag_convert is
  port (
    data_in : in std_logic_vector( 1-1 downto 0 );
    valid_in : in std_logic_vector( 1-1 downto 0 );
    data_out : out std_logic_vector( 2-1 downto 0 )
  );
end receiver_dqpsk_imag_convert;
architecture structural of receiver_dqpsk_imag_convert is 
  signal mux_y_net : std_logic_vector( 2-1 downto 0 );
  signal constant_op_net : std_logic_vector( 2-1 downto 0 );
  signal constant1_op_net : std_logic_vector( 2-1 downto 0 );
  signal register5_q_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receiver/Frame Synchronisation/QPSK Frame Sync/DQPSK Imag Decision
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receiver_dqpsk_imag_decision is
  port (
    data_in : in std_logic_vector( 1-1 downto 0 );
    valid_in : in std_logic_vector( 1-1 downto 0 );
    clk_20 : in std_logic;
...
end receiver_dqpsk_imag_decision;
architecture structural of receiver_dqpsk_imag_decision is 
  signal src_ce_net : std_logic;
  signal logical1_y_net : std_logic_vector( 1-1 downto 0 );
  signal register3_q_net : std_logic_vector( 1-1 downto 0 );
  signal register_q_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receiver/Frame Synchronisation/QPSK Frame Sync/DQPSK Real Convert
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receiver_dqpsk_real_convert is
  port (
    data_in : in std_logic_vector( 1-1 downto 0 );
    valid_in : in std_logic_vector( 1-1 downto 0 );
    data_out : out std_logic_vector( 2-1 downto 0 )
  );
end receiver_dqpsk_real_convert;
architecture structural of receiver_dqpsk_real_convert is 
  signal register4_q_net : std_logic_vector( 1-1 downto 0 );
  signal register5_q_net : std_logic_vector( 1-1 downto 0 );
  signal constant1_op_net : std_logic_vector( 2-1 downto 0 );
  signal mux_y_net : std_logic_vector( 2-1 downto 0 );
...
-- Generated from Simulink block receiver/Frame Synchronisation/QPSK Frame Sync/DQPSK Real Decision
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receiver_dqpsk_real_decision is
  port (
    data_in : in std_logic_vector( 1-1 downto 0 );
    valid_in : in std_logic_vector( 1-1 downto 0 );
    clk_20 : in std_logic;
...
end receiver_dqpsk_real_decision;
architecture structural of receiver_dqpsk_real_decision is 
  signal src_ce_net : std_logic;
  signal src_clk_net : std_logic;
  signal register5_q_net : std_logic_vector( 1-1 downto 0 );
  signal slice_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  src_clk_net <= clk_20;
  src_ce_net <= ce_20;
  dqpsk_imag_convert : entity xil_defaultlib.receiver_dqpsk_imag_convert 
  port map (
    data_in => register4_q_net_x0,
    valid_in => register5_q_net_x0,
    data_out => mux_y_net_x0
  );
  dqpsk_imag_decision : entity xil_defaultlib.receiver_dqpsk_imag_decision 
  port map (
  ...
  dqpsk_real_convert : entity xil_defaultlib.receiver_dqpsk_real_convert 
  port map (
    data_in => register4_q_net,
    valid_in => register5_q_net,
    data_out => mux_y_net
  );
  dqpsk_real_decision : entity xil_defaultlib.receiver_dqpsk_real_decision 
  port map (
    data_in => slice_y_net,
    valid_in => logical1_y_net,
    clk_20 => src_clk_net,
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_c3a2a5d7f86610d9e1032f6cd8be3beb 
  port map (
    s_axis_data_tdata_real => mux_y_net,
    en => register5_q_net(0),
    src_clk => src_clk_net,
  ...
  fir_compiler_7_2_1 : entity xil_defaultlib.xlfir_compiler_2ce8af7ebe7f11266b30ed9117102e20 
  port map (
...
begin
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_eaa597fff7cd5573cded9d6d720d8c7f 
  port map (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_e4424ba9cd426d22eb1d3ddfdfab67a8 
  port map (
