...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net bpsk_transmitter_m_axis [get_bd_intf_pins bpsk_transmitter/m_axis] [get_bd_intf_pins usp_rf_data_converter/s10_axis]
