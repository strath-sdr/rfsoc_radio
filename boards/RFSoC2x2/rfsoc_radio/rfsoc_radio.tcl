...
\
  ...
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins DataInspectorRx/aresetn] [get_bd_pins receiver/receiver_aresetn] [get_bd_pins axi_dma_rx/axi_resetn] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins ps8_axi_periph/M04_ARESETN] [get_bd_pins ps8_axi_periph/M05_ARESETN] [get_bd_pins ps8_axi_periph/M06_ARESETN] [get_bd_pins usp_rf_data_converter/m2_axis_aresetn]
  connect_bd_net -net proc_sys_reset_dac1_peripheral_aresetn [get_bd_pins proc_sys_reset_dac1/peripheral_aresetn] [get_bd_pins DataInspectorTx/aresetn] [get_bd_pins transmitter/transmitter_aresetn] [get_bd_pins axi_dma_tx/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ps8_axi_periph/M01_ARESETN] [get_bd_pins ps8_axi_periph/M02_ARESETN] [get_bd_pins ps8_axi_periph/M07_ARESETN] [get_bd_pins usp_rf_data_converter/s1_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_clk_adc0 [get_bd_pins usp_rf_data_converter/clk_adc2] [get_bd_pins DataInspectorRx/aclk] [get_bd_pins receiver/clk] [get_bd_pins axi_dma_rx/s_axi_lite_aclk] [get_bd_pins axi_dma_rx/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S01_ACLK] [get_bd_pins proc_sys_reset_adc0/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M04_ACLK] [get_bd_pins ps8_axi_periph/M05_ACLK] [get_bd_pins ps8_axi_periph/M06_ACLK] [get_bd_pins usp_rf_data_converter/m2_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac1 [get_bd_pins usp_rf_data_converter/clk_dac1] [get_bd_pins DataInspectorTx/aclk] [get_bd_pins transmitter/clk] [get_bd_pins axi_dma_tx/s_axi_lite_aclk] [get_bd_pins axi_dma_tx/m_axi_mm2s_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M02_ACLK] [get_bd_pins ps8_axi_periph/M07_ACLK] [get_bd_pins usp_rf_data_converter/s1_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -with_name SEG_axi_dma_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspectorTx/axi_dma/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -with_name SEG_data_inspector_module_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspectorTx/data_inspector_module/inspector_s_axi/reg0] -force
