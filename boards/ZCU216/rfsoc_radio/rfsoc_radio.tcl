...
proc create_hier_cell_DataInspectorTx { parentCell nameHier } {
  ...
  connect_bd_net -net axi_dma_s2mm_introut1 [get_bd_pins axi_dma/s2mm_introut] [get_bd_pins irq]
  connect_bd_net -net proc_sys_reset_clk_dac1_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins data_inspector_module/inspector_aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins s_axi_interconnect/ARESETN] [get_bd_pins s_axi_interconnect/S00_ARESETN] [get_bd_pins s_axi_interconnect/M00_ARESETN] [get_bd_pins s_axi_interconnect/M01_ARESETN]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins aclk] [get_bd_pins data_inspector_module/clk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins s_axi_interconnect/ACLK] [get_bd_pins s_axi_interconnect/S00_ACLK] [get_bd_pins s_axi_interconnect/M00_ACLK] [get_bd_pins s_axi_interconnect/M01_ACLK]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {8} $ps8_axi_periph
  ...
  set_property CONFIG.NUM_PORTS {6} $xlconcat
...
\
  ...
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins proc_sys_reset_adc1/peripheral_aresetn] [get_bd_pins DataInspectorRx/aresetn] [get_bd_pins receiver/receiver_aresetn] [get_bd_pins axi_dma_rx/axi_resetn] [get_bd_pins axi_mem_intercon_hp2/ARESETN] [get_bd_pins axi_mem_intercon_hp2/S00_ARESETN] [get_bd_pins axi_mem_intercon_hp2/M00_ARESETN] [get_bd_pins axi_mem_intercon_hp2/S01_ARESETN] [get_bd_pins axis_broadcaster/aresetn] [get_bd_pins ps8_axi_periph/M04_ARESETN] [get_bd_pins ps8_axi_periph/M05_ARESETN] [get_bd_pins ps8_axi_periph/M06_ARESETN] [get_bd_pins usp_rf_data_converter/m1_axis_aresetn]
  ...
  connect_bd_net -net proc_sys_reset_dac2_peripheral_aresetn [get_bd_pins proc_sys_reset_dac2/peripheral_aresetn] [get_bd_pins DataInspectorTx/aresetn] [get_bd_pins transmitter/transmitter_aresetn] [get_bd_pins axi_dma_tx/axi_resetn] [get_bd_pins axi_mem_intercon_hp0/ARESETN] [get_bd_pins axi_mem_intercon_hp0/S00_ARESETN] [get_bd_pins axi_mem_intercon_hp0/M00_ARESETN] [get_bd_pins axi_mem_intercon_hp0/S01_ARESETN] [get_bd_pins ps8_axi_periph/M01_ARESETN] [get_bd_pins ps8_axi_periph/M02_ARESETN] [get_bd_pins ps8_axi_periph/M07_ARESETN] [get_bd_pins usp_rf_data_converter/s2_axis_aresetn]
  connect_bd_net -net receiver_0_irq [get_bd_pins receiver/irq] [get_bd_pins xlconcat/In1]
  connect_bd_net -net rst_ps8_99M_peripheral_aresetn [get_bd_pins rst_ps8_99M/peripheral_aresetn] [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins ps8_axi_periph/ARESETN] [get_bd_pins ps8_axi_periph/S00_ARESETN] [get_bd_pins ps8_axi_periph/M00_ARESETN] [get_bd_pins ps8_axi_periph/M03_ARESETN] [get_bd_pins usp_rf_data_converter/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins usp_rf_data_converter/clk_adc1] [get_bd_pins DataInspectorRx/aclk] [get_bd_pins receiver/clk] [get_bd_pins axi_dma_rx/s_axi_lite_aclk] [get_bd_pins axi_dma_rx/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon_hp2/ACLK] [get_bd_pins axi_mem_intercon_hp2/S00_ACLK] [get_bd_pins axi_mem_intercon_hp2/M00_ACLK] [get_bd_pins axi_mem_intercon_hp2/S01_ACLK] [get_bd_pins axis_broadcaster/aclk] [get_bd_pins proc_sys_reset_adc1/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M04_ACLK] [get_bd_pins ps8_axi_periph/M05_ACLK] [get_bd_pins ps8_axi_periph/M06_ACLK] [get_bd_pins usp_rf_data_converter/m1_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac1 [get_bd_pins usp_rf_data_converter/clk_dac1] [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins usp_rf_data_converter/s1_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac3 [get_bd_pins usp_rf_data_converter/clk_dac2] [get_bd_pins DataInspectorTx/aclk] [get_bd_pins transmitter/clk] [get_bd_pins axi_dma_tx/s_axi_lite_aclk] [get_bd_pins axi_dma_tx/m_axi_mm2s_aclk] [get_bd_pins axi_mem_intercon_hp0/ACLK] [get_bd_pins axi_mem_intercon_hp0/S00_ACLK] [get_bd_pins axi_mem_intercon_hp0/M00_ACLK] [get_bd_pins axi_mem_intercon_hp0/S01_ACLK] [get_bd_pins proc_sys_reset_dac2/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M02_ACLK] [get_bd_pins ps8_axi_periph/M07_ACLK] [get_bd_pins usp_rf_data_converter/s2_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  connect_bd_net -net xlconcat_dout [get_bd_pins xlconcat/dout] [get_bd_pins axi_intc/intr]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins zynq_ultra_ps_e/pl_clk0] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins ps8_axi_periph/ACLK] [get_bd_pins ps8_axi_periph/S00_ACLK] [get_bd_pins ps8_axi_periph/M00_ACLK] [get_bd_pins ps8_axi_periph/M03_ACLK] [get_bd_pins rst_ps8_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins zynq_ultra_ps_e/pl_resetn0] [get_bd_pins proc_sys_reset_adc1/ext_reset_in] [get_bd_pins proc_sys_reset_dac1/ext_reset_in] [get_bd_pins proc_sys_reset_dac2/ext_reset_in] [get_bd_pins rst_ps8_99M/ext_reset_in]
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -with_name SEG_axi_dma_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspectorTx/axi_dma/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -with_name SEG_data_inspector_module_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs DataInspectorTx/data_inspector_module/inspector_s_axi/reg0] -force
